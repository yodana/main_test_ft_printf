...
int main()
{
        ...
        printf("reel printf: lf -> %ld\n",2147483650);
        ft_printf("mine : lf -> %ld\n\n",2147483650);
 
        printf("reel printf: llf -> %lld\n",c);
        ft_printf("mine : llf -> %lld\n\n",c);
        ...
        printf("reel : champ anf + with f neg -> %20f|\n",-10.0);
        ft_printf("mine : champ anf + with f neg -> %20f|\n\n",-10.0);
